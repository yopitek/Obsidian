...
|---|-----------|----------------|---------|-------|
| 01 | Orchestrator | `orchestrator` | ReAct 框架 PM，任務分解與分派 | [agent.md](01_orchestrator/agent.md) |
| 02 | Obsidian Builder | `obsidian-builder` | 知識管理，vault 寫入與維護 | [agent.md](02_Obsidian_Builder/agent.md) |
| 03 | Art Expert | `art-expert` | 視覺設計，行銷圖片生成 | [agent.md](03_Art_Expert/agent.md) |
| 04 | Video Director | `video-director` | 影片腳本、分鏡、B-roll | [agent.md](04_Video_Director/agent.md) |
| 05 | Content Writer | `content-writer` | SEO 文案，多平台內容 | [agent.md](05_Content_Writer/agent.md) |
| 06 | Financial Analyst | `financial-analyst` | 股市追蹤，財務週報 | [agent.md](06_Financial_Analyst/agent.md) |
| 07 | Market Researcher | `market-researcher` | WiFi7/5G 市場研究，競品分析 | [agent.md](07_Market_Researcher/agent.md) |
| 08 | Software Engineer | `software-engineer` | 程式開發，MCP，CI/CD | [agent.md](08_Software_Engineer/agent.md) |
| 09 | Data Engineer | `data-engineer` | 資料管線，格式轉換，RAG | [agent.md](09_Data_Engineer/agent.md) |
| 10 | Social Publisher | `social-publisher` | 跨平台發布，排程管理 | [agent.md](10_social_publisher/agent.md) |
| 11 | Report Designer | `report-designer` | PPT 簡報，資訊圖表，提案文件 | [agent.md](11_Report_Designer/agent.md) |
...
**技能檔：** [skill.md](01_orchestrator/skill.md)
...
**技能檔：** [skill.md](02_Obsidian_Builder/skill.md)
...
**技能檔：** [skill.md](03_Art_Expert/skill.md)
...
**技能檔：** [skill.md](04_Video_Director/skill.md)
...
**技能檔：** [skill.md](05_Content_Writer/skill.md)
...
**技能檔：** [skill.md](06_Financial_Analyst/skill.md)
...
**技能檔：** [skill.md](07_Market_Researcher/skill.md)
...
**技能檔：** [skill.md](08_Software_Engineer/skill.md)
...
**技能檔：** [skill.md](09_Data_Engineer/skill.md)
...
**排程檔：** [schedule.md](10_social_publisher/schedule.md) | **技能檔：** [skill.md](10_social_publisher/skill.md)
...
**技能檔：** [skill.md](11_Report_Designer/skill.md)

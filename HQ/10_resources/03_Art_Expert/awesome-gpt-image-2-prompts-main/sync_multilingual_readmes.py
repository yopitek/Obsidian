...
def build_locale(base: str, cfg: dict) -> str:
    ...
    text = replace_once(text, "Try it on Evolink: [GPT-Image-2](https://evolink.ai/models?utm_source=github&utm_medium=picture&utm_campaign=awesome-gpt-image-2-prompts)", cfg["intro_try"])
...
def main() -> None:
    ...
    for cfg in LOCALES.values():
        cfg["path"].write_text(build_locale(base, cfg), encoding="utf-8")
